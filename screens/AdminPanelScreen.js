    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Vue d'ensemble de l'activité de l'application</Text>
        </View>
      </View>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Text style={styles.soonText}>
            D'autres métriques utiles pour les administrateurs pourront être ajoutées ici plus tard
            (engagement, participation aux événements, etc.).
          </Text>
        </ScrollView>
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  card: { flex: 1, backgroundColor: "#111827", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "#1f2937" },
  cardLabel: { color: "#9ca3af", fontSize: 13 },
  cardValue: { color: "#fff", fontSize: 26, fontWeight: "700", marginTop: 6 },
  soonText: { color: "#6b7280", fontSize: 13, marginTop: 24 },
});
